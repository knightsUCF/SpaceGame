...
* a big thing that is easy to overlook is staying continuously organized in the project, which includes:
  ...
  * staying organized really does not require that much discipline (but nevertheless requires some), which if we don't do, tidying up the project later will be near impossible! We must stay organized!
