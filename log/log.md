...
Again, no prototyping! Even when we get to the hangar and workers, work first toward getting to a simple fun core MVP, so we are always in a state of working product, and not a prototype or a tech demo!
